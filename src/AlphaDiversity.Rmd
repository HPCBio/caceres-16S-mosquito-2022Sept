...
Look at significance of metrics across Env_Comp_Den using Kruskal Wallace test (non-parametric ANOVA).
...
Also looked at significance of metrics for Density using Kruskal Wallace test (non-parametric ANOVA).
