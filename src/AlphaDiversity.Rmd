...
Based on alpha rarefaction and alpha diversity analysis there does appear to be a difference with strain (key one) but here it's slight.
...
<!-- ```{r } -->
<!-- saveRDS(physeq.filtered, file = "../results/phyloseq.filtered.alphadiv.RDS") -->
<!-- ``` -->
