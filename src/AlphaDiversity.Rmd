...
Chao1, Observed, & Faith PD are normal. The others are skewed. May need to split up our plot into a parametric test for the former metrics and nonparametric for the other metrics

Look at significance of metrics across Env_Comp_Den using Kruskal Wallace test.
...
In the metrics that consider abundance and richness (Shannon, Simpson, InvSimpson), all groups are significant. Technically the other metrics showed a normal distribution and would be better suited for an anova test. This can be added later.
