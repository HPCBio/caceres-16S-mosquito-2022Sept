...
p1 = plot_ordination(physeq.active,
                     ...
                     shape = "Competition",
                     label = "Environment",
                     title="PCoA, Bray Curtis distance") + geom_point(size = 2.5)
p1
ggsave("pcoa-braycurtis-density-competition-environment.pdf", path = "../results/final-plots/", device = "pdf")
```
...
ggsave("pcoa-wunifrac-density-competition-environment.pdf", path = "../results/final-plots/", device = "pdf")
```
...
NOTE, Infusion stock samples have been removed for the PERMANOVA analyses.
