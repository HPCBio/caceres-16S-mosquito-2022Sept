...
p1
ggsave("pcoa-braycurtis-density-competition-environment_Mosquito.pdf", path = "./results/final-plots/", device = "pdf")
```
...
ggsave("pcoa-wunifrac-density-competition-environment_Mosquito.pdf", path = "./results/final-plots/", device = "pdf")
```
...
p1 = plot_ordination(physeq.active,
                     ...
                     title="PCoA, Bray Curtis distance") + geom_point(size = 2.5)
p1
ggsave("pcoa-braycurtis-density-competition-environment_ExpWater.pdf", path = "./results/final-plots/", device = "pdf")
```
...
ggsave("pcoa-wunifrac-density-competition-environment_ExpWater.pdf", path = "./results/final-plots/", device = "pdf")
```
