...
res.test = generateContrastResults(deseq = finalPhyseq.adds,
                              ...
                              physeq = physeq.prev,
                              file = "~/research/biotech/young-chae_kim/2021-Fall-Microbiome/results/DESeq2/Overall-C57BL.6-FvsM.txt"
)
...
res.test = generateContrastResults(deseq = finalPhyseq.adds,
                              ...
                              physeq = physeq.prev,
                              file = "~/research/biotech/young-chae_kim/2021-Fall-Microbiome/results/DESeq2/Overall-SHP.T58A-FvsM.txt"
)
dim(res.test[which(res.test$padj <= 0.05), ])
```
...
res.test = generateContrastResults(deseq = finalPhyseq.adds,
                              ...
                              physeq = physeq.prev,
                              file = "~/research/biotech/young-chae_kim/2021-Fall-Microbiome/results/DESeq2/Overall-Male-SHP.T58AvsC57BL.6.txt"
)
dim(res.test[which(res.test$padj <= 0.05), ])
```
...
res.test = generateContrastResults(deseq = finalPhyseq.adds,
                              ...
                              physeq = physeq.prev,
                              file = "~/research/biotech/young-chae_kim/2021-Fall-Microbiome/results/DESeq2/Overall-Female-SHP.T58AvsC57BL.6.txt"
)
dim(res.test[which(res.test$padj <= 0.05), ])
```
