...
ggsave("Diff-Abund_Family_Water-vs-Larvae", path = "results/DESeq2", width = 11, height = 8,device = "pdf")
```

Plot at Genus-level
```{r }
plotDESeq2ResGenus(res.test)
ggsave("Diff-Abund_Genus_Water-vs-Larvae", path = "results/DESeq2/", width = 12, height = 8, device = "pdf")
```

Plot at Species-level
```{r }
plotDESeq2ResSpecies(res.test)
ggsave("Diff-Abund_Species_Water-vs-Larvae", path = "results/DESeq2/", width = 18, height = 10, device = "pdf")
```
...
```{r }
plotDESeq2ResFamily(res.test)
ggsave("Diff-Abund_Family_Stock.Water-vs-Water", path = "results/DESeq2", width = 8, height = 6,device = "pdf")
```

Plot at Genus-level
```{r }
plotDESeq2ResGenus(res.test)
ggsave("Diff-Abund_Genus_Stock.Water-vs-Water", path = "results/DESeq2/", width = 10, height = 6, device = "pdf")
```

Plot at Species-level
```{r }
plotDESeq2ResSpecies(res.test)
ggsave("Diff-Abund_Species_Stock.Water-vs-Water", path = "results/DESeq2/", width = 12, height = 6, device = "pdf")
```
...
```{r }
plotDESeq2ResFamily(res.test)
ggsave("Diff-Abund_Family_20-vs-40", path = "results/DESeq2", width = 5, height = 4.5, device = "pdf")
```

Plot at Genus-level
```{r }
plotDESeq2ResGenus(res.test)
ggsave("Diff-Abund_Genus_20-vs-40", path = "results/DESeq2/", width = 5, height = 4.5, device = "pdf")
```

Plot at Species-level
```{r }
plotDESeq2ResSpecies(res.test)
ggsave("Diff-Abund_Species_20-vs-40", path = "results/DESeq2/", width = 5, height = 5.5, device = "pdf")
```
...
```{r }
plotDESeq2ResFamily(res.test)
ggsave("Diff-Abund_Family_G-vs-GN", path = "results/DESeq2", width = 10, height = 5,device = "pdf")
```

Plot at Genus-level
```{r }
plotDESeq2ResGenus(res.test)
ggsave("Diff-Abund_Genus_G-vs-GN", path = "results/DESeq2/", width = 14, height = 6, device = "pdf")
```

Plot at Species-level
```{r }
plotDESeq2ResSpecies(res.test)
ggsave("Diff-Abund_Species_G-vs-GN", path = "results/DESeq2/", width = 18, height = 8, device = "pdf")
```
