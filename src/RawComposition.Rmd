...
There are no Species-level assignments for top 20 families, and the top 20 families only make up, at most, 20% of the total abundance. This indicates that we have very diverse communities here with high taxonomic resolution. This is not surprising considering that we have 18,538 ASVs to start with. It will be beneficial to glom ASVs at the species or genus level to reduce this high resolution we're seeing.
